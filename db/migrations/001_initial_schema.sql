-- Initial schema: users, tweets, flashcard tables
-- This migration is non-destructive (CREATE IF NOT EXISTS / DO blocks)
...
-- Card status enum (safe: only create if it doesn't exist)
DO $$
BEGIN
